...
2) Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/emidinho/realworld-cicd-pipeline-project/blob/main/scripts/install-jenkins.sh
    - Launch Instance
...
4) Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/emidinho/realworld-cicd-pipeline-project/blob/main/scripts/install-nexus.sh
    - Launch Instance
